...
voiture_raf = Voiture.new  #les class doivent toutes avoir une Majuscule   #.new cré une instance de la class voiture que je rentre dans une variable "voiture_raf"
